...
export const HERO_CONTENT = `I am an aspiring full stack developer with a knack for crafting robust and scalable web applications. 
With some months of hands-on experience, I am Polishing my skills in front-end technologies like React, Next js and React Native, as well as
back-end technologies like Python, Node js, MySQL and MongoDB. My goal is to leverage and improve my expertise to create innovative solutions
